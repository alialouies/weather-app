...
let givenCity = "alaska";
const URL = `http://api.openweathermap.org/data/2.5/weather?q=${givenCity}&appid=bb7021d558856f2a9f14a9dfc4cffa82`

submitBtn.addEventListener('click', () => {

    const searchedCity = document.getElementById('location');
    const givenCity = searchedCity.value;
